...
<nav class="fixed bottom-0 z-50 flex h-24 w-full items-center justify-around rounded-t-[2rem] border-t border-[#e8f5e9] bg-white px-4 pb-safe shadow-[0_-8px_32px_rgba(0,0,0,0.08)]">
    ...
    >
        <span class="material-symbols-outlined mb-1" style="font-variation-settings: 'FILL' {{ $isMarkRoadActive ? 1 : 0 }}">polyline</span>
    ...
    >
        <span class="material-symbols-outlined mb-1" style="font-variation-settings: 'FILL' {{ $isLogActive ? 1 : 0 }}">history</span>
    ...
    >
        <span class="material-symbols-outlined mb-1" style="font-variation-settings: 'FILL' {{ $isSetupActive ? 1 : 0 }}">settings</span>
